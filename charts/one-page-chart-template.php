...
class Disciple_Tools_Gamification_Chart_Template extends DT_Metrics_Chart_Base
{
    public $base_slug = 'disciple-tools-gamification-metrics'; // lowercase
    public $base_title = "Disciple Tools Gamification Metrics";
