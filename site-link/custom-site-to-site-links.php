...
class Disciple_Tools_Gamification_Site_Links {
    public $type = 'disciple_tools_gamification';
    ...
    public function site_link_type( $type ) {
        $type[$this->type] = __( 'Disciple Tools Gamification' );
        return $type;
    }
}
Disciple_Tools_Gamification_Site_Links::instance();
